...
@section('page-title', 'Tambah Mesin Baru')
    ...
    <div class="col-lg-8">
        <div class="card-custom animate-in">
            <div class="card-header-custom">
                <h6><i class="bi bi-plus-circle me-2"></i>Form Tambah Mesin</h6>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                <input type="number" step="0.5" min="0.5" max="24"
                                       ...
                                       value="{{ old('operating_hours_per_day', 24) }}" required>
