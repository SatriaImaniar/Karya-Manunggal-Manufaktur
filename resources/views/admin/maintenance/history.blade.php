        ...
        <div class="card-custom">
            ...
            <div class="card-body-custom">
                <form action="{{ route('admin.maintenance.history.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        <label for="machine_id" class="form-label fw-semibold">Pilih Mesin <span class="text-danger">*</span></label>
                        <select class="form-select @error('machine_id') is-invalid @enderror"
                            ...
                            @foreach($machines as $machine)
                                <option value="{{ $machine->id }}" {{ old('machine_id') == $machine->id ? 'selected' : '' }}>
                                    {{ $machine->code }} — {{ $machine->name }} ({{ $machine->operating_hours_per_day }} jam/hari)
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="row g-3">
                        <div class="col-12">
                            ...
                            <div class="input-group">
                                <input type="number" step="0.01" min="0.01"
                                       ...
                                       value="{{ old('waktu_operasi_jam') }}"
                                       placeholder="Contoh: 2400" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" min="1"
                                   ...
                                   id="jumlah_kerusakan" name="jumlah_kerusakan"
                                   value="{{ old('jumlah_kerusakan') }}"
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label for="period_start" class="form-label fw-semibold">Awal Periode <span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-6">
                            <label for="period_end" class="form-label fw-semibold">Akhir Periode <span class="text-danger">*</span></label>
                    ...
                    <div class="mt-3 p-3 rounded-3" style="background:#f0f9ff;border:1px solid #bae6fd">
                        ...
                        <div style="font-size:.8rem;color:#334155">
                            <strong>MTBF</strong> = T / N <span class="text-muted">(rata-rata waktu antar kerusakan)</span><br>
                            <strong>MTTR</strong> = Tr / N <span class="text-muted">(rata-rata waktu perbaikan)</span><br>
                            <strong>Tpm</strong> = 0.7 × MTBF <span class="text-muted">(interval maintenance preventif)</span>
                        </div>
                    </div>
